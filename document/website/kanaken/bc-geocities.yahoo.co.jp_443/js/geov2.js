...
function getUAd() {
  ...
  element.innerHTML =
    '<center><iframe style="border:none;" src="https://bc-geocities.yahoo.co.jp/bc/uad?i=' +
    jps +
    "&u=" +
    ...
    "&ad=" +
    encodeURIComponent(adFlg) +
    "&shp=" +
    encodeURIComponent(shpAdFlg) +
    '" width=615 height=' +
    ifrmHeight +
    ' border=0 marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling=no allowtransparency="true"></iframe></center>';
  return element;
}
...
function measureSiteHeight() {
  if (!canUseGetBoundingClientRect()) {
    var bodyHeight = Math.max.apply(null, [
